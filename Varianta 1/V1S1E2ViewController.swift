...
class V1S1E2ViewController: UIViewController, UIPopoverPresentationControllerDelegate {
    ...
    @objc func screenEdgeSwiped(_ recognizer: UIScreenEdgePanGestureRecognizer) {
        if recognizer.state == .recognized {
            performSegue(withIdentifier: "areyasure", sender: self)
        }
    }
    ...
    func correctanswer1()
    {
        ...
        c1.backgroundColor = UIColor.red
